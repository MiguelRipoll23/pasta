...
import type { BalanceHistorySectionProps } from "../../interfaces/bank-account-detail/balance-history-section-props-interface";
import { HistoryCard } from "./HistoryCard";

export const BalanceHistorySection: React.FC<BalanceHistorySectionProps> = ({
  balances,
  onAdd,
  onEdit,
  onDelete,
  ...
  <div>
    ...
    {balances.length === 0
      ? <div className="text-center py-12 text-gray-500 dark:text-gray-400">No balance records yet</div>
      : (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-gray-900 dark:text-white capitalize">{formatDate(balance.createdAt)}</p>
                </div>
                <span className="text-sm font-mono text-right text-gray-900 dark:text-white">
